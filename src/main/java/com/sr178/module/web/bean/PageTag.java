package com.sr178.module.web.bean;
...
public class PageTag implements Tag { 
    ...
    public int doEndTag() throws JspTagException {
    	try {
    		...
    		if (!isEmpty(paraStr)) {
				...
				if (paraArr != null && paraArr.length > 0) {
					for (int i = 0; i < paraArr.length; i=i+2) {
						...
						if (!isEmpty(para) && paraNum == 0 && !isEmpty(value)) {
							url = url + "?" + para + "=" + value;
							paraNum++;
						} else if (!isEmpty(para) && paraNum > 0 && !isEmpty(value)) {
							url = url + "&amp;" + para + "=" + value;
							paraNum++;
						}
					}	
    		...
    		if (!isEmpty(para1) && paraNum == 0 && !isEmpty(value1)) {
    			url = url + "?" + para1 + "=" + value1;
    			paraNum++;
    		} else if (!isEmpty(para1) && paraNum > 0 && !isEmpty(value1)) {
    			url = url + "&amp;" + para1 + "=" + value1;
    			paraNum++;
    		}
    		
    		if (!isEmpty(para2) && paraNum > 0 && !isEmpty(value2)) {
    			url = url + "&amp;" + para2 + "=" + value2;
    			paraNum++;
    		} else if (!isEmpty(para2) && paraNum == 0 && !isEmpty(value2)) {
    			url = url + "?" + para2 + "=" + value2;
    			paraNum++;
    		}
    		
    		if (!isEmpty(para3) && paraNum > 0 && !isEmpty(value3)) {
    			url = url + "&amp;" + para3 + "=" + value3;
    			paraNum++;
    		} else if (!isEmpty(para3) && paraNum == 0 && !isEmpty(value3)) {
    			url = url + "?" + para3 + "=" + value3;
    			paraNum++;
    		}
    		
    		if (!isEmpty(para4) && paraNum > 0 && !isEmpty(value4)) {
    			url = url + "&amp;" + para4 + "=" + value4;
    			paraNum++;
    		} else if (!isEmpty(para4) && paraNum == 0 && !isEmpty(value4)) {
    			url = url + "?" + para4 + "=" + value4;
    			paraNum++;
    		}
    		...
    		if (!isEmpty(datePara1) && paraNum > 0 && !isEmpty(dateValue1Str)) {
    			url = url + "&amp;" + datePara1 + "=" + dateValue1Str;
    			paraNum++;
    		} else if (!isEmpty(datePara1) && paraNum == 0 && !isEmpty(dateValue1Str)) {
    			url = url + "?" + datePara1 + "=" + dateValue1Str;
    			paraNum++;
    		}
    		...
    		if (!isEmpty(datePara2) && paraNum > 0 && !isEmpty(dateValue2Str)) {
    			url = url + "&amp;" + datePara2 + "=" + dateValue2Str;
    			paraNum++;
    		} else if (!isEmpty(datePara2) && paraNum == 0 && !isEmpty(dateValue2Str)) {
    			url = url + "?" + datePara2 + "=" + dateValue2Str;
    			paraNum++;
    		}
        	//struts国际化
//    		ActionSupport actionSupport = new ActionSupport();
        	...
        	if (currentPage == 0 && totalPage > 0) {
        		if (paraNum <= 0) {
        			nextStr = "<a href='" + UrlFormat(url + "?toPage=" + (currentPage + 1), sessionID) + "'>" + nextPageText + "</a>";
        			upString = upPageText;
        		} else {
        			nextStr =  "<a href='" + UrlFormat(url + "&amp;toPage=" + (currentPage + 1), sessionID) + "'>" + nextPageText + "</a>";	
        			upString = upPageText;
        		...
        		if (paraNum <= 0) {
        			nextStr = "<a href='" + UrlFormat(url + "?toPage=" + (currentPage + 1), sessionID) + "'>" + nextPageText + "</a>";
        			upString = "<a href='" + UrlFormat(url + "?toPage=" + (currentPage - 1), sessionID) + "'>" + upPageText + "</a>";
        		} else {
        			nextStr = "<a href='" + UrlFormat(url + "&amp;toPage=" + (currentPage + 1), sessionID) + "'>" + nextPageText + "</a>";
        			upString = "<a href='" + UrlFormat(url + "&amp;toPage=" + (currentPage - 1), sessionID) + "'>" + upPageText + "</a>";
        		}
        	...
        	if(paraNum <= 0){
        			firstStr = "<a href='" + UrlFormat(url + "?toPage=" + 0, sessionID) + "'>"+firstPageText+"</a>";
        			endStr = "<a href='" + UrlFormat(url + "?toPage=" + (totalPage), sessionID) + "'>"+endPageText+"</a>";
        		}else{
        			firstStr = "<a href='" + UrlFormat(url + "&amp;toPage=" + 0, sessionID) + "'>"+firstPageText+"</a>";
        			endStr = "<a href='" + UrlFormat(url + "&amp;toPage=" + (totalPage), sessionID) + "'>"+endPageText+"</a>";
        	}
	...
	public String UrlFormat(String url, String sessionID) {
		if (url.indexOf("?") > -1) {
